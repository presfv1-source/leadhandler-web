...
export function UpgradeCard({ feature }: { feature: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-blue-200 bg-blue-50 p-16 text-center min-h-64">
      ...
      <p className="text-slate-500 text-sm mb-6 max-w-xs leading-relaxed font-sans">
